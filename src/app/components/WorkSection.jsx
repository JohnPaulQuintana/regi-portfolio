  ...
  return (
    <section className="work-stand section-padding sub-bg desktop:px-40">
      ...
      <div className="sec-head mb-4">
        ...
        <div className="row">
          {/* filter links */}
          <div className="filtering col-12 mb-2 text-center">

            <div className="filter mb-4">
              <span className="text">Filter By :</span>
              <span data-filter="*" className={activeFilter === "*" ? "active text-color-primary-green" : ""}
              ...
              <span
                data-filter=".graphic" className={activeFilter === ".graphic" ? "active text-color-primary-green" : "relative"}
              ...
              <span
                data-filter=".web" className={activeFilter === ".web" ? "active text-color-primary-green" : ""}
                onClick={() => handleFilterClick(".web")}
              >
                Web Solutions
              </span>
              <span
              data-filter=".video" className={activeFilter === ".video" ? "active text-color-primary-green" : ""}
