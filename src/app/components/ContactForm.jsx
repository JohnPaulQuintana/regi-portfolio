...
const ContactForm = () => {
    ...
    return (
        <section className="contact section-padding desktop:px-40 contact">
                    ...
                    <div className="col-lg-4 valign">
                        <div className="sec-head info-box full-width md-mb80">
                            ...
                            <div className="social-icon-circle mt-4 flex gap-2">
                                <a href="https://www.facebook.com/irving.barawid.9">
                                    <i className="fab fa-facebook-f"></i>
                                </a>
                                <a href="tel:+639289662856">
                    ...
                    <div className="col-lg-7 offset-lg-1 valign">
                        <div className="full-width">
                            <div className="sec-head mb-4">
                                <h6 className="sub-title text-color-primary-green mb-2 font-bold">Let's Chat</h6>
